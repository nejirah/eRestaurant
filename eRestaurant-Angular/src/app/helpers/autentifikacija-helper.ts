import { LoginInformacije, Registracija } from "./login-informacije";
...
export class AutentifikacijaHelper {
  ...
  static setRegistracija(x:Registracija,y:number): void {
    if(y==1){
      x.isRegistracija=true;
    }
    else{
      x.isRegistracija=false;
    }
  }
}
